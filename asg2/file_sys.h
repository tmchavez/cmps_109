...
class inode_state {
   ...
   public:
      ...
      void pushdir(const string& nextdir);
      void popdirs();
};
...
class base_file {
   ...
   public:
      ...
      virtual void mkdirref (const string& dirname, inode_ptr par) = 0;
      virtual inode_ptr mkfile (const string& filename) = 0;
      virtual inode_ptr searchmap(const string& filename) = 0;
      virtual void removekey(const string& keyname) = 0;
...
class plain_file: public base_file {
   ...
   public:
      ...
      virtual void mkdirref (const string& dirname, inode_ptr par) override;
      virtual inode_ptr mkfile (const string& filename) override;
      virtual inode_ptr searchmap(const string& filename) override;
      virtual void removekey(const string& keyname) override;
      virtual void printmap() override;
      virtual int checktype() override;
};
